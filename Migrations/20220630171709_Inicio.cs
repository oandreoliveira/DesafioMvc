        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModoDePreparo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsumoReceitas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InsumoReceitas_Ingredientes_IngredienteId",
                        column: x => x.IngredienteId,
                        principalTable: "Ingredientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InsumoReceitas_Medidas_MedidaId",
                        column: x => x.MedidaId,
                        principalTable: "Medidas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InsumoReceitas_Receitas_ReceitaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsumoReceitas_IngredienteId",
                table: "InsumoReceitas",
                column: "IngredienteId");

            migrationBuilder.CreateIndex(
                name: "IX_InsumoReceitas_MedidaId",
                table: "InsumoReceitas",
                column: "MedidaId");

            migrationBuilder.CreateIndex(
                name: "IX_InsumoReceitas_ReceitaId",
                table: "InsumoReceitas",
                column: "ReceitaId");
